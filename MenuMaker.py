...
class MenuMaker:
    ...
    def define_menu_structure():
        ...
        member_page.add_menu_item(MenuItem("Filter members", collection_controller.filter, None, member_page))
        member_page.add_menu_item(MenuItem("Reset filter", collection_controller.reset_filter, None, member_page))
        ...
        user_page.add_menu_item(MenuItem("Filter users", collection_controller.filter, None, user_page))
        user_page.add_menu_item(MenuItem("Reset filter", collection_controller.reset_filter, None, user_page))
